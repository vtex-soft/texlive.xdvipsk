/* This is xdvipsk, an eXtended version of dvips(k) by Tomas Rokicki.
 ...
 Copyright 2016-2017 by VTeX Ltd (www.vtex.lt),
 the xdvipsk project team - Arunas Povilaitis, Sigitas Tolusis 
 and Mindaugas Piesina.

 Program original code copyright by Tomas Rokicki (www.radicaleye.com).
...
//AP--begin
char banner3[] = BANNER_VTEX;  /* our third startup message */
//AP--end
